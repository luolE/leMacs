...
(defun cn-weather ()
  "Print recently days weather info in minibuffer."
  (interactive)
  (cn-weather-query 'cn-weather-parse-all-weather-str cn-weather-city))
...
(defun cn-weather-parse-all-weather-str (str)
  "Parse the future two days' weather info.
STR is a string containing the weather info."
  (let ((fields (split-string str ",")))
    (let ((fields-pairs
