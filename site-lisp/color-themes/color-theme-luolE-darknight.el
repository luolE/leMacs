(defun color-theme-luolE-darknight ()
  "Color subtheme, created 2012-02-13."
  (interactive)
  (color-theme-install
   '(color-theme-luolE-darknight nil nil
     ...
     (tabbar-button-face ((t (:bold t :background "gray30" :foreground "gray70" :weight bold :height 100 :family "DejaVu Sans Mono"))))
     ...
     (highlight-symbol-face ((t (:background "DarkSlateGray4" :foreground "cyan1"))))
     (highlight-80+ ((t (nil))))
     ...
     (completions-annotations ((t (:italic t :slant italic :underline t))))
     ...
     (ac-selection-face ((t (:background "OliveDrab1" :foreground "grey20"))))
     ...
     (ac-completion-face ((t (:background "OliveDrab1" :foreground "gray10"))))
     (ac-candidate-face ((t (:background "grey20" :foreground "grey80"))))
